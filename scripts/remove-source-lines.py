...
REPLACE_LINE_PATTERN = r"(\s*)(.*)\s*//!STUDENT_WILL_SEE\s*\((.*)\)"
    ...
    for line_num, line in enumerate(lines):
        ...
        if is_makefile:
            ...
            if match:
                ...
                if mode == "comment":
                    new_lines.append(f"{indent}{replacement_text} # TODO: replace this !STUDENT_SHOULD_WRITE({original_text})\n")
                else:
                    new_lines.append(f"{indent}{replacement_text} # TODO: replace this\n")
                lines_removed += 1
                continue
